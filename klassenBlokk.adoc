...
| Merknad 2 / _Note 2_ | Utvidelse sammenlignet med DCAT-AP-N: Kravnivået er endret fra valgfri til obligatorisk og multiplisitet endret fra 0..n til 1..1. 

_Extension compared to DCAT-AP-NO: The requirement level is changed from optional to mandatroy, and the multiplicity from 0..n to 1..1.__
|===
...
==== Blokk - sektor (dcat:theme) [[Blokk-tema]] 
...
| Kravnivå / _Requirement level_ | Obligatorisk / _Mandatory_
| Merknad 1 / _Note 1_ | Verdien bør velges fra EUs kontrollerte vokabular https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://publications.europa.eu/resource/authority/data-theme[Data theme &#x29C9;, window="_blank", role="ext-link"], https://psi.norge.no/los/struktur.html[Los &#x29C9;, window="_blank", role="ext-link"], og/eller andre sektorspesifikke taksonomier. 
...
| Merknad 2 / _Note 2_ | Utvidelse sammenlignet med DCAT-AP-NO: Egenskapsnavnet er endret fra «tema» til «sektor». Dette fordi i konteksten av denne spesifikasjonen er EUs kontrollerte vokabularet som skal brukes for denne egenskapen, mer en sektorklassifisering enn dataklassifisering.  
...
| Merknad 1 / _Note 1_ | Utvidelse sammenlignet med DCAT-AP-NO: Kravnivået er endret fra obligatorisk til anbefalt, tilsvarende med multiplisitet fra 1..n til 0..n. Dette fordi ikke alle har beskrivelse på blokknivå som metadata. 
...
| Merknad 1 / _Note 1_ | Verdien bør velges fra kontrollerte vokabularer, f.eks. EUs kommende kontrollerte vokabularer for livshendelser, sektorspesifikke kodeverk (SNOMED CT osv.) osv. 
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad / _Note_ | Utvidelse sammenlignet med DCAT-AP-N: Verdiområdet er endret fra dcat:Dataset til dcat:Resource. 
...
_The value should be chosen from a controlled vocabulary._ 
| Merknad / _Note_ | Utvidelse sammenlignet med DCAT-AP-NO: Denne er ikke eksplisitt spesifisert i DCAT-AP-NO. Dette for å kunne spesifisere målgruppen som blokkens innhold er primært ment for. 
