...
[cols="30s,70d"]
|===
| _English name_ | has related legal resource
...
[cols="30s,70d"]
|===
| _English name_ | source
| URI | dct:source
| Verdiområde / _Range_ | cdvno:Block
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til en blokk som gjeldende blokk er avledet fra.

_This property is used refer to a block from which the described block is derived._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
|===
