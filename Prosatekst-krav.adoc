...
[cols="15s,30,30,25"]
|===
| Obligatorisk |*Forklaring*|*Kontrollert vokabular*|*Eksempler*
|dato sist oppdatert
...
[cols="15s,30,30,25"]
|===
| Anbefalt |*Forklaring*|*Kontrollert vokabular*|*Eksempler*
|beskrivelse
...
[cols="15s,30,30,25"]
|===
| Valgfri |*Forklaring*|*Kontrollert vokabular*|*Eksempler*
|
